...
${u.__error}`:""));return}const{state:F,warnings:k}=u;window.dispatchEvent(new CustomEvent("remote-sync:local-import")),D(F),alert("Import übernommen."),A(t)}),a.target.value="")}),(h=$("#btn-seed"))==null||h.addEventListener("click",()=>{var l,m;const a={...e,openingEur:"10.000,00",incomings:[{month:((l=e==null?void 0:e.settings)==null?void 0:l.startMonth)||"2025-02",revenueEur:"20.000,00",payoutPct:.85},{month:"2025-03",revenueEur:"22.000,00",payoutPct:.85}],extras:[{month:"2025-04",label:"USt-Erstattung",amountEur:"1.500,00"}],fixcosts:[{id:"fix-export-demo",name:"Fixkosten",category:"Miete",amount:"2.000,00",frequency:"monthly",intervalMonths:1,anchor:"LAST",startMonth:((m=e==null?void 0:e.settings)==null?void 0:m.startMonth)||"2025-02",endMonth:"",proration:{enabled:!1,method:"none"},autoPaid:!0,notes:"Demo-Position"}],fixcostOverrides:{}};D(a),alert("Testdaten geladen."),A(t)})}export{A as render};
