...
export const ACCOUNTANT_SHEET_SCHEMAS = Object.freeze({
  ...
  arrivals: {
    ...
    columns: [
      ...
      { key: "anzahlungBetragEur", label: "Anzahlung EUR", cellType: "currency", columnWidth: 15, alignment: "right" },
      { key: "anzahlungDatum", label: "Anzahlung Datum", cellType: "date", columnWidth: 14 },
      { key: "restzahlungBetragEur", label: "Restzahlung EUR", cellType: "currency", columnWidth: 15, alignment: "right" },
      { key: "restzahlungDatum", label: "Restzahlung Datum", cellType: "date", columnWidth: 14 },
  ...
  inventory: {
    ...
    columns: [
      ...
      { key: "gesamtbestand", label: "Gesamtbestand (inkl. Zulauf)", cellType: "integer", columnWidth: 16, alignment: "right" },
      { key: "einstandspreisEur", label: "Einstandspreis EUR", cellType: "currency", columnWidth: 16, alignment: "right" },
      { key: "bestandswertEur", label: "Bestandswert EUR (nur Lager)", cellType: "currency", columnWidth: 18, alignment: "right" },
      { key: "bestandswertImZulaufEur", label: "davon im Zulauf EUR (nicht im Bestandswert)", cellType: "currency", columnWidth: 20, alignment: "right" },
...
export function buildAccountantOverviewRows(report) {
  ...
  const rows = [
    ...
    { label: "Warenbestand EUR (nur Lager)", value: inventory.totalValueEur, cellType: "currency" },
    { label: "davon im Zulauf EUR (nicht im Bestandswert)", value: inventory.totalInTransitValueEur ?? null, cellType: "currency" },
