...
export function validateProducts(products = [], settings = {}) {
  const issues = [];
...
export function validateAll({ settings, products, suppliers, pos, fos } = {}) {
  const issues = [
...
export const DATA_HEALTH_SCOPES = ["settings", "product", "supplier", "po", "fo"];
export const DATA_HEALTH_CURRENCIES = [...CURRENCIES];
