// Gemeinsame State-Validierung für UI (WorkspaceTransferPanel) und fba-cli.
// Framework-frei (.mjs), damit Node sie direkt laden kann und Vite sie bundelt.
// Einzige Wahrheit — die frühere Kopie in tools/fba-cli/validate.mjs re-exportiert nur noch.
// Hinweis: app_sync erzwingt diese Regeln NICHT serverseitig — Validierung ist advisory.
