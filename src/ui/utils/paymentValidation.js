import { parseMoneyInput } from "./numberFormat.js";

export function normalizePaymentId(value) {
...
export function allocatePayment(total, selectedEvents) {
...
export function validatePaymentModalState({
  selectedEvents,
  actualRaw,
  invoiceUrl,
  folderUrl,
