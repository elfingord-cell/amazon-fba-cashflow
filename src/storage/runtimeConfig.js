...
function isDevLikeEnvironment() {
  try {
    if (typeof import.meta !== "undefined" && import.meta?.env) {
      ...
      if (String(import.meta.env.MODE || "").toLowerCase() === "development") return true;
      if (String(import.meta.env.MODE || "").toLowerCase() === "test") return true;
    }
  } catch {
    // no-op
  }
...
export function setRuntimeConfig(next, source = "manual") {
...
export function getRuntimeLoadError() {
