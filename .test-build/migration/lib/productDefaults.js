...
exports.resolveSupplierContext = resolveSupplierContext;
exports.resolveFxRate = resolveFxRate;
exports.resolveProductionLeadTimeDays = resolveProductionLeadTimeDays;
exports.resolveTransportMode = resolveTransportMode;
exports.resolveTransportLeadTimeDays = resolveTransportLeadTimeDays;
exports.resolveUnitPriceUsd = resolveUnitPriceUsd;
exports.resolveCurrency = resolveCurrency;
exports.resolveLogisticsPerUnitEur = resolveLogisticsPerUnitEur;
exports.resolveDutyRatePct = resolveDutyRatePct;
exports.resolveEustRatePct = resolveEustRatePct;
exports.resolveDdp = resolveDdp;
exports.resolvePaymentTerms = resolvePaymentTerms;
...
function resolveSupplierContext(state, sku, supplierId) {
    ...
    const inferredSupplierId = explicitSupplier
        || fromLink?.supplierId
...
function resolveLogisticsPerUnitEur({ product, productSupplier, fxRate, unitPriceUsd }) {
    ...
    const estimated = (0, costing_js_1.computeFreightPerUnitEur)({
...
function resolveDdp({ product, settings }) {
    ...
    if (typeof template.ddp === "boolean")
        return template.ddp;
    if (typeof product?.ddp === "boolean")
        return product.ddp;
    if (typeof settings?.defaultDdp === "boolean")
        return settings.defaultDdp;
    return false;
}
