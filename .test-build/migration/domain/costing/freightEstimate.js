...
exports.computeFreightEstimate = computeFreightEstimate;
...
function resolveFreightMode(po) {
    ...
    if (VALID_FREIGHT_MODES.has(mode))
        return mode;
...
function computeFreightEstimate(po, productsBySku) {
    ...
    items.forEach((item) => {
        ...
        if (fxOk && unitCostUsd != null && landedUnitCostEur != null) {
            const computed = (0, costing_js_1.computeFreightPerUnitEur)({
