...
function renderItemsTable(container, record, onChange, dataListId) {
    ...
    record.items.forEach(item => {
        ...
        row.append(el("td", {}, [skuInput]), el("td", {}, [unitsInput]), el("td", {}, [unitCostInput]), el("td", {}, [unitExtraInput]), el("td", {}, [flatInput]), el("td", { dataset: { logisticsCell: "true" } }, [logisticsCell]), el("td", {}, [removeBtn]));
        body.append(row);
    });
    const table = el("table", {
