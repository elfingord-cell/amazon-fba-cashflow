...
function Hn(s) {
  let i = 0, a = 0, u = true;
  for (; s; )
    !s.offsetParent && s.tagName === "BODY" && s.scrollLeft === 0 && s.scrollTop === 0 && (s = document.scrollingElement || s), i += s.offsetLeft - (u ? 0 : s.scrollLeft) + s.clientLeft, a += s.offsetTop - (u ? 0 : s.scrollTop) + s.clientTop, s = s.offsetParent, u = false;
  return { x: i, y: a };
}
function jt(s) {
  if (s === document.body)
  ...
  (function(a, u) {
    ...
    function u(t) {
      for (var e = 1; e < arguments.length; e++) {
        ...
        e % 2 ? a(Object(r), true).forEach(function(n) {
          x(t, n, r[n]);
    ...
    function m(t, e) {
      for (var r = 0; r < e.length; r++) {
        var n = e[r];
        n.enumerable = n.enumerable || false, n.configurable = true, "value" in n && (n.writable = true), Object.defineProperty(t, C(n.key), n);
      }
    }
    function y(t, e, r) {
      return e && m(t.prototype, e), Object.defineProperty(t, "prototype", { writable: false }), t;
    }
    function x(t, e, r) {
      return (e = C(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: true, configurable: true, writable: true }) : t[e] = r, t;
    }
    function O(t, e) {
      if (typeof e != "function" && e !== null) throw new TypeError("Super expression must either be null or a function");
      t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: true, configurable: true } }), Object.defineProperty(t, "prototype", { writable: false }), e && P(t, e);
    }
    function $(t) {
    ...
    var ce = { id: "actions/drag", install: function(t) {
      ...
      if (o && o.enabled && (!e.pointerIsDown || !/mouse|pointer/.test(e.pointerType) || n & r.options.drag.mouseButtons)) return t.action = { name: "drag", axis: o.lockAxis === "start" ? o.startAxis : o.lockAxis }, false;
    } }, draggable: function(t) {
      return S.object(t) ? (this.options.drag.enabled = t.enabled !== false, this.setPerAction("drag", t), this.setOnEvents("drag", t), /^(xy|x|y|start)$/.test(t.lockAxis) && (this.options.drag.lockAxis = t.lockAxis), /^(xy|x|y)$/.test(t.startAxis) && (this.options.drag.startAxis = t.startAxis), this) : S.bool(t) ? (this.options.drag.enabled = t, this) : this.options.drag;
    ...
    function ke(t) {
      return !!S.string(t) && (W.document.querySelector(t), true);
    }
    function H(t, e) {
    ...
    var wt = function() {
      function t(e) {
        v(this, t), this.immediatePropagationStopped = false, this.propagationStopped = false, this._interaction = e;
      }
    ...
    var tn = function(t, e) {
      ...
      function r(n, o, l) {
        var c;
        v(this, r), (c = e.call(this, o._interaction)).dropzone = void 0, c.dragEvent = void 0, c.relatedTarget = void 0, c.draggable = void 0, c.propagationStopped = false, c.immediatePropagationStopped = false;
      ...
      return y(r, [{ key: "reject", value: function() {
        ...
        if (this.type === "dropactivate" || this.dropzone && o.cur.dropzone === this.dropzone && o.cur.element === this.target) if (o.prev.dropzone = this.dropzone, o.prev.element = this.target, o.rejected = true, o.events.enter = null, this.stopImmediatePropagation(), this.type === "dropactivate") {
    ...
    function nn(t, e) {
      for (var r = 0, n = t.slice(); r < n.length; r++) {
        ...
        e.dropzone = l, e.target = c, l.fire(e), e.propagationStopped = e.immediatePropagationStopped = false;
      }
    }
    function rr(t, e) {
    ...
    var an = { id: "actions/drop", install: function(t) {
      ...
      t.usePlugin(ne), n.prototype.dropzone = function(l) {
        return function(c, p) {
          if (S.object(p)) {
            if (c.options.drop.enabled = p.enabled !== false, p.listeners) {
      ...
      }, H(e.phaselessTypes, { dragenter: true, dragleave: true, dropactivate: true, dropdeactivate: true, dropmove: true, drop: true }), e.methodDict.drop = "dropzone", t.dynamicDrop = false, o.actions.drop = an.defaults;
      ...
      if (e.prepared.name === "drag") {
        var r = e.dropState;
        r && (r.activeDrops = null, r.events = null, r.cur.dropzone = null, r.cur.element = null, r.prev.dropzone = null, r.prev.element = null, r.rejected = false);
      }
    ...
    }, defaults: { enabled: false, accept: null, overlap: "pointer" } }, co = an;
    function or(t) {
    ...
    var sr = { id: "actions/gesture", before: ["actions/drag", "actions/resize"], install: function(t) {
      ...
      r.prototype.gesturable = function(o) {
        return S.object(o) ? (this.options.gesture.enabled = o.enabled !== false, this.setPerAction("gesture", o), this.setOnEvents("gesture", o), this) : S.bool(o) ? (this.options.gesture.enabled = o, this) : this.options.gesture;
    ...
    var Ie, Ne, Pe = { id: "actions/resize", before: ["actions/drag"], install: function(t) {
      ...
      if (o) {
        ...
        if (p && p.enabled && (!e.pointerIsDown || !/mouse|pointer/.test(e.pointerType) || l & p.mouseButtons)) {
          if (S.object(p.edges)) {
            var h = { left: false, right: false, top: false, bottom: false };
    ...
    } }, V = { defaults: { enabled: false, margin: 60, container: null, speed: 300 }, now: Date.now, interaction: null, i: 0, x: 0, y: 0, isScrolling: false, prevTime: 0, margin: 0, speed: 0, start: function(t) {
      V.isScrolling = true, je.cancel(V.i), t.autoScroll = V, V.interaction = t, V.prevTime = V.now(), V.i = je.request(V.scroll);
    }, stop: function() {
      V.isScrolling = false, V.interaction && (V.interaction.autoScroll = null), je.cancel(V.i);
    }, scroll: function() {
    ...
    var vo = { id: "auto-scroll", install: function(t) {
      ...
      t.autoScroll = V, V.now = function() {
        return t.now();
      }, r.phaselessTypes.autoscroll = true, e.perAction.autoScroll = V.defaults;
    }, listeners: { "interactions:new": function(t) {
    ...
    function ct(t, e) {
      var r = false;
      return function() {
        return r || (G.console.warn(e), r = true), t.apply(this, arguments);
      };
    }
    function ar(t, e) {
    ...
    var wo = { id: "auto-start/base", before: ["actions"], install: function(t) {
      ...
      t.usePlugin(yo), r.base.actionChecker = null, r.base.styleCursor = true, H(r.perAction, { manualStart: false, max: 1 / 0, maxPerElement: 1, allowFrom: null, ignoreFrom: null, mouseButtons: 1 }), e.maxInteractions = function(n) {
        return vn(n, t);
        ...
        return function(n, o, l) {
          ...
          if (c !== "never") if (c !== "always") {
            if (o.events.supportsPassive && /^touch(start|move)$/.test(l.type)) {
              ...
              if (!h || !h.events || h.events.passive !== false) return;
            }
    ...
    function xt(t, e) {
      ...
      for (var r in e.map) if (t.indexOf(r) === 0 && t.substr(r.length) in e.phases) return true;
      return false;
    }
    function Be(t) {
      var e = {};
    ...
    var pr = function() {
      function t(e) {
        v(this, t), this.states = [], this.startOffset = { left: 0, right: 0, top: 0, bottom: 0 }, this.startDelta = void 0, this.result = void 0, this.endResult = void 0, this.startEdges = void 0, this.edges = void 0, this.interaction = void 0, this.interaction = e, this.result = Ot(), this.edges = { left: false, right: false, top: false, bottom: false };
      }
      return y(t, [{ key: "start", value: function(e, r) {
        ...
        var h = this.fillArg({ phase: l, pageCoords: r, preEnd: false });
        ...
        if (this.result = c, !c.changed && (!l || l < this.states.length) && r.interacting()) return false;
        if (e.modifiedCoords) {
        ...
        if (o && o.length) {
          for (var l = false, c = 0; c < o.length; c++) {
            var p = o[c];
            e.state = p;
            var h = p.options, g = p.methods, d = g.beforeEnd && g.beforeEnd(e);
            if (d) return this.endResult = d, false;
            l = l || !l && this.shouldDo(h, true, e.phase, true);
          }
          l && r.move({ event: n, preEnd: true });
        }
        ...
        return !(!e || e.enabled === false || o && !e.endOnly || e.endOnly && !r || n === "start" && !e.setStart);
    ...
    function Ae(t, e) {
      var r = t.defaults, n = { start: t.start, set: t.set, beforeEnd: t.beforeEnd, stop: t.stop }, o = function(l) {
        var c = l || {};
        for (var p in c.enabled = c.enabled !== false, r) p in c || (c[p] = r[p]);
        var h = { options: c, methods: n, name: e, enable: function() {
          return c.enabled = true, h;
        }, disable: function() {
          return c.enabled = false, h;
        } };
        return h;
      };
    ...
    } } }, bn = Eo, yn = { base: { preventDefault: "auto", deltaSource: "page" }, perAction: { enabled: false, origin: { x: 0, y: 0 } }, actions: {} }, hr = function(t) {
      O(r, t);
      var e = _(r);
    ...
    var Io = y(function t(e, r, n, o, l) {
      ...
      function t(e) {
        ...
        v(this, t), this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = { name: null, axis: null, edges: null }, this.pointerType = void 0, this.pointers = [], this.downEvent = null, this.downPointer = {}, this._latestPointer = { pointer: null, event: null, eventTarget: null }, this.prevEvent = null, this.pointerIsDown = false, this.pointerWasMoved = false, this._interacting = false, this._ending = false, this._stopped = true, this._proxy = void 0, this.simulation = null, this.doMove = ct(function(d) {
          this.move(d);
      ...
      return y(t, [{ key: "pointerMoveTolerance", get: function() {
        ...
        var o = this.updatePointer(e, r, n, true), l = this.pointers[o];
        ...
        return !(this.interacting() || !this.pointerIsDown || this.pointers.length < (e.name === "gesture" ? 2 : 1) || !r.options[e.name].enabled) && (ar(this.prepared, e), this.interactable = r, this.element = n, this.rect = r.getRect(n), this.edges = this.prepared.edges ? H({}, this.prepared.edges) : { left: true, right: true, top: true, bottom: true }, this._stopped = false, this._interacting = this._doPhase({ interaction: this, event: this.downEvent, phase: "start" }) && !this._stopped, this._interacting);
      } }, { key: "pointerMove", value: function(e, r, n) {
        this.simulation || this.modification && this.modification.endResult || this.updatePointer(e, r, n, false);
        ...
        l === -1 && (l = this.updatePointer(e, r, n, false));
        ...
        var r;
        this._ending = true, e = e || this._latestPointer.event, this.interacting() && (r = this._doPhase({ event: e, interaction: this, phase: "end" })), this._ending = false, r === true && this.stop();
        ...
        return o = o !== false && (o || /(down|start)$/i.test(r.type)), d ? d.pointer = e : (d = new Io(h, e, r, null, null), g = this.pointers.length, this.pointers.push(d)), lo(this.coords.cur, this.pointers.map(function(b) {
          return b.pointer;
        }), this._now()), l = this.coords.delta, c = this.coords.prev, p = this.coords.cur, l.page.x = p.page.x - c.page.x, l.page.y = p.page.y - c.page.y, l.client.x = p.client.x - c.client.x, l.client.y = p.client.y - c.client.y, l.timeStamp = p.timeStamp - c.timeStamp, o && (this.pointerIsDown = true, d.downTime = this.coords.cur.timeStamp, d.downTarget = n, bt(this.downPointer, e), this.interacting() || (yt(this.coords.start, this.coords.cur), yt(this.coords.prev, this.coords.cur), this.downEvent = r, this.pointerWasMoved = false)), this._updateLatestPointer(e, r, n), this._scopeFire("interactions:update-pointer", { pointer: e, event: r, eventTarget: n, down: o, pointerInfo: d, pointerIndex: g, interaction: this }), g;
      } }, { key: "removePointer", value: function(e, r) {
        var n = this.getPointerIndex(e);
        if (n !== -1) {
          var o = this.pointers[n];
          this._scopeFire("interactions:remove-pointer", { pointer: e, event: r, eventTarget: null, pointerIndex: n, pointerInfo: o, interaction: this }), this.pointers.splice(n, 1), this.pointerIsDown = false;
        }
        ...
        if (c && n === "move" && (mt(this.edges, c, this.coords.delta[this.interactable.options.deltaSource]), c.width = c.right - c.left, c.height = c.bottom - c.top), this._scopeFire("interactions:before-action-".concat(n), e) === false) return false;
        var p = e.iEvent = this._createPreparedEvent(r, n, o, l);
        return this._scopeFire("interactions:action-".concat(n), e), n === "start" && (this.prevEvent = p), this._fireEvent(p), this._scopeFire("interactions:after-action-".concat(n), e), true;
    ...
    function Sn(t) {
      ...
      return dr(t.coords.cur, e), dr(t.coords.delta, e), mt(t.edges, t.rect, e), e.x = 0, e.y = 0, true;
    }
    function $o(t) {
      var e = t.x, r = t.y;
    ...
    var ko = { id: "offset", before: ["modifiers", "pointer-events", "actions", "inertia"], install: function(t) {
      ...
      return y(t, [{ key: "start", value: function(e) {
        ...
        if (c.copyFrom(r.modification), this.t0 = r._now(), this.allowResume = n.allowResume, this.v0 = l, this.currentOffset = { x: 0, y: 0 }, this.startCoords = r.coords.cur.page, this.modifierArg = c.fillArg({ pageCoords: this.startCoords, preEnd: true, phase: "inertiastart" }), this.t0 - r.coords.cur.timeStamp < 50 && l > n.minSpeed && l > n.endSpeed) this.startInertia();
        else {
          if (c.result = c.setAll(this.modifierArg), !c.result.changed) return false;
          this.startSmoothEnd();
        }
        return r.modification.result.rect = null, r.offsetBy(this.targetOffset), r._doPhase({ interaction: r, event: e, phase: "inertiastart" }), r.offsetBy({ x: -this.targetOffset.x, y: -this.targetOffset.y }), r.modification.result.rect = null, this.active = true, r.simulation = this, true;
        ...
        p.pageCoords = { x: this.startCoords.x + this.targetOffset.x, y: this.startCoords.y + this.targetOffset.y }, c.result = c.setAll(p), c.result.changed && (this.isModified = true, this.modifiedOffset = { x: this.targetOffset.x + c.result.delta.x, y: this.targetOffset.y + c.result.delta.y }), this.onNextFrame(function() {
        ...
        l.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }), l.updatePointer(r, n, o, true), l._doPhase({ interaction: l, event: n, phase: "resume" }), yt(l.coords.prev, l.coords.cur), this.stop();
      } }, { key: "end", value: function() {
        this.interaction.move(), this.interaction.end(), this.stop();
      } }, { key: "stop", value: function() {
        this.active = this.smoothEnd = false, this.interaction.simulation = null, je.cancel(this.timeout);
      } }]), t;
    }();
    function Ct(t) {
    ...
    var jo = { id: "inertia", before: ["modifiers", "actions"], install: function(t) {
      var e = t.defaults;
      t.usePlugin(xn), t.usePlugin(bn), t.actions.phases.inertiastart = true, t.actions.phases.resume = true, e.perAction.inertia = { enabled: false, resistance: 10, minSpeed: 100, endSpeed: 10, allowResume: true, smoothEndDuration: 300 };
    }, listeners: { "interactions:new": function(t) {
      var e = t.interaction;
      e.inertia = new zo(e);
    }, "interactions:before-action-end": function(t) {
    ...
    var Mn = function() {
      function t(e) {
        v(this, t), this.options = void 0, this.types = {}, this.propagationStopped = false, this.immediatePropagationStopped = false, this.global = void 0, this.options = H({}, e || {});
      }
    ...
    function pt(t) {
      return S.object(t) ? { capture: !!t.capture, passive: !!t.passive } : { capture: !!t, passive: false };
    }
    function _t(t, e) {
    ...
    var Ho = { id: "events", install: function(t) {
            ...
            if (q.selector === d && q.context === b) {
              for (var ee = q.listeners, B = ee.length - 1; B >= 0; B--) {
                ...
                if (Z.func === I && _t(Z.options, L)) {
                  ee.splice(B, 1), ee.length || (j.splice(D, 1), p(b, w, h), p(b, w, g, true)), Y = true;
                  break;
                }
              }
              if (Y) break;
      ...
      }, delegateListener: h, delegateUseCapture: g, delegatedEvents: n, documents: o, targets: r, supportsOptions: false, supportsPassive: false };
      function c(d, b, w, I) {
            ...
            if (j) {
              ...
              for (var ee = pt(I), B = 0; B < j.length; B++) {
                ...
                if (Z.func === w && _t(Z.options, ee)) {
                  d.removeEventListener(b, w, l.supportsOptions ? ee : ee.capture), j.splice(B, 1), j.length === 0 && (delete D.events[b], L = true);
                  break;
                }
              }
            }
      ...
      return (e = t.document) == null || e.createElement("div").addEventListener("test", null, { get capture() {
        return l.supportsOptions = true;
      }, get passive() {
        return l.supportsPassive = true;
      } }), t.events = l, l;
    ...
    function gr(t, e) {
      ...
      for (var h in n.browser.isIOS && !o.events && (o.events = { passive: false }), c.delegatedEvents) p(r, h, c.delegateListener), p(r, h, c.delegateUseCapture, true);
    ...
    var Fo = { id: "core/interactions", install: function(t) {
      ...
      return y(t, [{ key: "_defaults", get: function() {
        ...
        for (var o in r) {
          ...
          l === "listeners" && this.updatePerActionListeners(e, c.listeners, p), S.array(p) ? c[l] = rn(p) : S.plainObject(p) ? (c[l] = H(c[l] || {}, Be(p)), S.object(n.perAction[l]) && "enabled" in n.perAction[l] && (c[l].enabled = p.enabled !== false)) : S.bool(p) && S.object(n.perAction[l]) ? c[l].enabled = p : c[l] = p;
        }
      } }, { key: "getRect", value: function(e) {
      ...
      return y(t, [{ key: "new", value: function(e, r) {
        ...
        return this.scope.addDocument(n._doc), this.list.push(n), S.string(e) ? (this.selectorMap[e] || (this.selectorMap[e] = []), this.selectorMap[e].push(n)) : (n.target[this.scope.id] || Object.defineProperty(e, this.scope.id, { value: [], configurable: true }), e[this.scope.id].push(n)), this.scope.fire("interactable:new", { target: e, options: r, interactable: n, win: this.scope._win }), n;
      ...
      function t() {
        var e = this;
        v(this, t), this.id = "__interact_scope_".concat(Math.floor(100 * Math.random())), this.isInitialized = false, this.listenerMaps = [], this.browser = R, this.defaults = Be(yn), this.Eventable = Mn, this.actions = { map: {}, phases: { start: true, move: true, end: true }, methodDict: {}, phaselessTypes: {} }, this.interactStatic = function(n) {
      ...
      return y(t, [{ key: "addListeners", value: function(e, r) {
        ...
        for (var n = 0, o = this.listenerMaps; n < o.length; n++) {
          var l = o[n].map[e];
          if (l && l(r, this, e) === false) return false;
        }
      } }, { key: "init", value: function(e) {
        return this.isInitialized ? this : function(r, n) {
          return r.isInitialized = true, S.window(n) && Q(n), W.init(n), R.init(n), je.init(n), r.window = n, r.document = n.document, r.usePlugin(Uo), r.usePlugin(Ho), r;
        }(this, e);
    ...
    var Xo = Object.freeze({ __proto__: null, edgeTarget: function() {
      ...
      if (p !== false && H(n, b), d != null && d.length) {
    ...
    }, defaults: { restriction: null, elementRect: null, offset: null, endOnly: false, enabled: false } }, es = Ae(Et, "restrict"), kn = { top: 1 / 0, left: 1 / 0, bottom: -1 / 0, right: -1 / 0 }, zn = { top: -1 / 0, left: -1 / 0, bottom: 1 / 0, right: 1 / 0 };
    function jn(t, e) {
    ...
    var ht = { noInner: kn, noOuter: zn, start: function(t) {
    ...
    }, defaults: { inner: null, outer: null, offset: null, endOnly: false, enabled: false } }, ts = Ae(ht, "restrictEdges"), rs = H({ get elementRect() {
    ...
    }, defaults: { min: null, max: null, endOnly: false, enabled: false } }, "restrictSize"), mr = { start: function(t) {
      ...
      for (var Y = { target: null, inRange: false, distance: 0, range: 0, delta: { x: 0, y: 0 } }, q = 0; q < h.length; q++) {
        var ee = h[q], B = ee.range, Z = ee.x - p.x, me = ee.y - p.y, le = ot(Z, me), Te = le <= B;
        B === 1 / 0 && Y.inRange && Y.range !== 1 / 0 && (Te = false), Y.target && !(Te ? Y.inRange && B !== 1 / 0 ? le / B < Y.distance / Y.range : B === 1 / 0 && Y.range !== 1 / 0 || le < Y.distance : !Y.inRange && le < Y.distance) || (Y.target = ee, Y.distance = le, Y.range = B, Y.inRange = Te, Y.delta.x = Z, Y.delta.y = me);
      }
      return Y.inRange && (r.x = Y.target.x, r.y = Y.target.y), n.closest = Y, Y;
    }, defaults: { range: 1 / 0, targets: null, offset: null, offsetWithOrigin: true, origin: null, relativePoints: null, endOnly: false, enabled: false } }, as = Ae(mr, "snap"), It = { start: function(t) {
    ...
    }, defaults: { range: 1 / 0, targets: null, offset: null, endOnly: false, enabled: false } }, ls = Ae(It, "snapSize"), br = { aspectRatio: Qo, restrictEdges: ts, restrict: es, restrictRect: ns, restrictSize: ss, snapEdges: Ae({ start: function(t) {
      var e = t.edges;
      ...
      function r(n, o, l, c, p, h) {
        ...
        } else n === "doubletap" && (g.dt = o.timeStamp - p.tapTime, g.double = true);
        return g;
      }
      ...
      yr(t), He(t, e);
    } }, PointerEvent: An, fire: He, collectEventTargets: Ln, defaults: { holdDuration: 600, ignoreFrom: null, allowFrom: null, origin: { x: 0, y: 0 } }, types: { down: true, move: true, up: true, cancel: true, tap: true, doubletap: true, hold: true } };
    function He(t, e) {
    ...
    var ds = { id: "pointer-events/holdRepeat", install: function(t) {
      ...
      var e = t.Interactable;
      t.actions.phases.reflow = true, e.prototype.reflow = function(r) {
        return function(n, o, l) {
          for (var c = n.getAllElements(), p = l.window.Promise, h = p ? [] : null, g = function() {
            ...
            if (E) E.move(), h && (I = E._reflowPromise || new p(function(j) {
              ...
              I = function(j, Y, q, ee, B) {
                ...
                Z.interactable = Y, Z.element = q, Z.prevEvent = B, Z.updatePointer(B, B, q, true), Vr(Z.coords.delta), ar(Z.prepared, ee), Z._doPhase(me);
...
(function(s, i) {
  (function(a, u) {
    ...
    var de = function() {
      function W(R) {
        this.$L = we(R.locale, null, true), this.parse(R), this.$x = this.$x || R.x || {}, this[S] = true;
      }
      var k = W.prototype;
      return k.parse = function(R) {
        ...
        if (!R) return this.$L;
        var A = this.clone(), K = we(R, F, true);
        return K && (A.$L = K), A;
      }, k.clone = function() {
    ...
    return ce.prototype = Ee, [["$ms", v], ["$s", m], ["$m", y], ["$H", x], ["$W", O], ["$M", P], ["$y", _], ["$D", M]].forEach(function(W) {
      ...
      return W.$i || (W(k, de, ce), W.$i = true), ce;
...
(function(s, i) {
  (function(a, u) {
    ...
    return function(v, m, y) {
      var x = m.prototype;
      y.utc = function(C) {
        var z = { date: C, utc: true, args: arguments };
        return new m(z);
      }, x.utc = function(C) {
        var z = y(this.toDate(), { locale: this.$L, utc: true });
      ...
      var O = x.parse;
      x.parse = function(C) {
        C.utc && (this.$u = true), this.$utils().u(C.$offset) || (this.$offset = C.$offset), O.call(this, C);
      };
      var $ = x.init;
      x.init = function() {
        if (this.$u) {
...
function ks(s) {
  ...
  if (a < 0)
    return false;
  var u = i.length - 1;
  return a == u ? i.pop() : $s.call(i, a, 1), --this.size, true;
}
var zs = ks;
var js = Yt;
function As(s) {
...
var ia = na;
var oa = typeof We == "object" && We && We.Object === Object && We;
var _i = oa;
var sa = _i;
var aa = typeof self == "object" && self && self.Object === Object && self;
var la = sa || aa || Function("return this")();
var $e = la;
var ca = $e;
var ua = ca.Symbol;
var kr = ua;
...
var pa = Mi.hasOwnProperty;
var ha = Mi.toString;
var vt = Wn ? Wn.toStringTag : void 0;
function da(s) {
...
var Ta = ba;
var wa = "[object Null]";
var Sa = "[object Undefined]";
var Un = Fn ? Fn.toStringTag : void 0;
function xa(s) {
...
var Ia = "[object GeneratorFunction]";
var Pa = "[object Proxy]";
function Da(s) {
  if (!_a(s))
    return false;
...
function jc(s, i, a, u, f, v) {
  ...
  if (O && $)
    return O == i && $ == s;
  var P = -1, T = true, _ = a & zc ? new Dc() : void 0;
...
var Bc = 1;
var Vc = 2;
var qc = "[object Boolean]";
var Zc = "[object Date]";
var Jc = "[object Error]";
var Qc = "[object Map]";
var eu = "[object Number]";
var tu = "[object RegExp]";
var ru = "[object Set]";
var nu = "[object String]";
var iu = "[object Symbol]";
var ou = "[object ArrayBuffer]";
var su = "[object DataView]";
var Bn = Kn ? Kn.prototype : void 0;
var Sr = Bn ? Bn.valueOf : void 0;
...
var xu = Su.propertyIsEnumerable;
var Vn = Object.getOwnPropertySymbols;
var Ou = Vn ? function(s) {
...
var zu = $i.hasOwnProperty;
var ju = $i.propertyIsEnumerable;
var Au = qn(/* @__PURE__ */ function() {
  return arguments;
}()) ? qn : function(s) {
...
Wt.exports;
(function(s, i) {
  var a = $e, u = Wu, f = i && !i.nodeType && i, v = f && true && s && !s.nodeType && s, m = v && v.exports === f, y = m ? a.Buffer : void 0, x = y ? y.isBuffer : void 0, O = x || u;
  s.exports = O;
})(Wt, Wt.exports);
var ki = Wt.exports;
...
var Zu = "[object Array]";
var Ju = "[object Boolean]";
var Qu = "[object Date]";
var ep = "[object Error]";
var tp = "[object Function]";
var rp = "[object Map]";
var np = "[object Number]";
var ip = "[object Object]";
var op = "[object RegExp]";
var sp = "[object Set]";
var ap = "[object String]";
var lp = "[object WeakMap]";
var cp = "[object ArrayBuffer]";
var up = "[object DataView]";
var pp = "[object Float32Array]";
var hp = "[object Float64Array]";
var dp = "[object Int8Array]";
var fp = "[object Int16Array]";
var vp = "[object Int32Array]";
var gp = "[object Uint8Array]";
var mp = "[object Uint8ClampedArray]";
var bp = "[object Uint16Array]";
var yp = "[object Uint32Array]";
var oe = {};
oe[pp] = oe[hp] = oe[dp] = oe[fp] = oe[vp] = oe[gp] = oe[mp] = oe[bp] = oe[yp] = true;
oe[qu] = oe[Zu] = oe[cp] = oe[Ju] = oe[up] = oe[Qu] = oe[ep] = oe[tp] = oe[rp] = oe[np] = oe[ip] = oe[op] = oe[sp] = oe[ap] = oe[lp] = false;
function Tp(s) {
...
Ft.exports;
(function(s, i) {
  var a = _i, u = i && !i.nodeType && i, f = u && true && s && !s.nodeType && s, v = f && f.exports === u, m = v && a.process, y = function() {
    try {
...
var Up = Fp;
var Np = Up;
var Yp = Np(Object.keys, Object);
var Gp = Yp;
var Kp = Wp;
var Xp = Gp;
var Bp = Object.prototype;
var Vp = Bp.hasOwnProperty;
function qp(s) {
  if (!Kp(s))
    return Xp(s);
  var i = [];
...
function vh(s, i, a, u, f, v) {
  ...
  if (C && !z) {
    ...
    te != re && "constructor" in s && "constructor" in i && !(typeof te == "function" && te instanceof te && typeof re == "function" && re instanceof re) && (C = false);
  }
...
var mh = Qe;
var bh = $e;
var yh = mh(bh, "DataView");
var Th = yh;
var wh = Qe;
var Sh = $e;
var xh = wh(Sh, "Promise");
var Oh = xh;
var Ch = Qe;
var _h = $e;
var Mh = Ch(_h, "Set");
...
var ei = "[object Map]";
var $h = "[object Object]";
var ti = "[object Promise]";
var ri = "[object Set]";
var ni = "[object WeakMap]";
...
function Kh(s, i, a, u, f, v) {
  ...
  return T ? (v || (v = new xr()), Uh(s, i, a, u, f, v)) : false;
}
var Xh = Kh;
var Bh = Xh;
var pi = Vt;
function Li(s, i, a, u, f) {
  return s === i ? true : s == null || i == null || !pi(s) && !pi(i) ? s !== s && i !== i : Bh(s, i, a, u, Li, f);
}
var Vh = Li;
var qh = Vh;
function Zh(s, i) {
...
function Hi({ item: s, itemContext: i, getItemProps: a, getResizeProps: u }) {
  ...
  return (0, import_react.createElement)(
    "div",
    { ...x, ref: y, key: `${m}-outer` },
    O ? (0, import_react.createElement)("div", { ...f, key: `${m}-lr` }) : null,
    (0, import_jsx_runtime.jsx)("div", { className: "rct-item-content", style: { maxHeight: `${i.dimensions.height}` }, children: i.title }, `${m}-content`),
    O ? (0, import_react.createElement)("div", { ...v, key: `${m}-rr` }) : null
  );
}
function Ut(s, i, a) {
  return (i - s) / a;
...
var Nr = import_react.default.createContext(ud);
var { Consumer: pd, Provider: hd } = Nr;
var dd = class extends import_react.default.Component {
  constructor(i) {
  ...
  render() {
    return (0, import_jsx_runtime.jsx)(hd, { value: this.state.timelineContext, children: this.props.children });
  }
};
var qt = pd;
var fd = () => (0, import_react.useContext)(Nr);
Me.extend(Cs);
var Yr = class extends import_react.Component {
  constructor(i) {
    super(i), Object.defineProperty(this, "state", {
      ...
      configurable: true,
      writable: true,
      value: (0, import_react.createRef)()
      ...
      writable: true,
      value: (a) => {
        this.state.interactMounted || (a.preventDefault(), this.startedClicking = true);
      }
      ...
      writable: true,
      value: (a) => {
        !this.state.interactMounted && this.startedClicking && (this.startedClicking = false, this.actualClick(a, "click"));
      }
      ...
      writable: true,
      value: (a) => {
        this.state.interactMounted || (a.preventDefault(), this.startedTouching = true);
      }
      ...
      writable: true,
      value: (a) => {
        !this.state.interactMounted && this.startedTouching && (this.startedTouching = false, this.actualClick(a, "touch"));
      }
  ...
  dragTime(i) {
    ...
    return this.state.dragging ? this.dragTimeSnap(this.timeFor(i) + this.state.dragStart.offset, true) : a.valueOf();
  }
  timeFor(i) {
  ...
  mountInteract() {
    const i = this.props.useResizeHandle ? ".rct-item-handler-resize-left" : true, a = this.props.useResizeHandle ? ".rct-item-handler-resize-right" : true;
    Tr(this.itemRef.current).resizable({
    ...
    }).styleCursor(false).on("dragstart", (u) => {
      if (this.props.selected) {
        this.dragInProgress = true, this.fireInteractEvent(true);
      ...
      if (this.state.dragging) {
        if (this.props.onDrop) {
          this.dragInProgress = false, this.fireInteractEvent(false);
      ...
      if (this.props.selected)
        this.fireInteractEvent(true), this.setState({
          resizing: true,
          resizeEdge: null,
          // we don't know yet
          resizeStart: u.pageX,
  ...
  canResizeLeft(i = this.props) {
    var u;
    return !i.canResizeLeft || i.minResizeWidth === void 0 ? false : parseInt((u = i.dimensions.width) == null ? void 0 : u.toString(), 10) >= i.minResizeWidth;
  }
  canResizeRight(i = this.props) {
    var u;
    return !i.canResizeRight || i.minResizeWidth === void 0 ? false : parseInt((u = i.dimensions.width) == null ? void 0 : u.toString(), 10) >= i.minResizeWidth;
  }
  ...
  componentDidUpdate(i) {
    ...
    if (this.itemRef && this.itemRef.current) {
      if (this.props.selected && !a && (this.mountInteract(), a = true), a && (f !== y || v !== x)) {
        const O = this.props.useResizeHandle ? this.dragLeft : true, $ = this.props.useResizeHandle ? this.dragRight : true;
        Tr(this.itemRef.current).resizable({
          enabled: y || x,
          edges: {
            top: false,
...
function gd(s, i) {
  const a = J(s, "canResize") !== void 0 ? J(s, "canResize") : i;
  return a === "right" || a === "both" || a === true;
}
var md = class extends import_react.Component {
...
var fi = class extends import_react.Component {
  ...
  renderGroupContent(i, a = false, u, f) {
    return this.props.groupRenderer ? import_react.default.createElement(this.props.groupRenderer, {
      group: i,
      isRightSidebar: a
    }) : J(i, a ? f : u);
  }
  render() {
    const { width: i, groupHeights: a, height: u, isRightSidebar: f } = this.props, { groupIdKey: v, groupTitleKey: m, groupRightTitleKey: y } = this.props.keys, x = {
      ...
      return (0, import_jsx_runtime.jsx)("div", { className: "rct-sidebar-row rct-sidebar-row-" + (T % 2 === 0 ? "even" : "odd"), style: _, children: this.renderGroupContent(P, f, m, y) }, J(P, v));
    });
    return (0, import_jsx_runtime.jsx)("div", { className: "rct-sidebar" + (f ? " rct-sidebar-right" : ""), style: x, children: (0, import_jsx_runtime.jsx)("div", { style: O, children: $ }) });
  }
};
var bd = class extends import_react.Component {
  shouldComponentUpdate(i) {
  ...
  render() {
    ...
    return Lr(i, a, u, f, (O, $) => {
      ...
      x.push((0, import_jsx_runtime.jsx)("div", { className: M, style: {
        pointerEvents: "none",
        top: "0px",
        left: `${C}px`,
        width: `${z - C}px`,
    ...
    }), (0, import_jsx_runtime.jsx)("div", { className: "rct-vertical-lines", children: x });
  }
};
var yd = ({ ...s }) => (0, import_jsx_runtime.jsx)(qt, { children: ({ getLeftOffsetFromDate: i }) => (0, import_jsx_runtime.jsx)(bd, { getLeftOffsetFromDate: i, ...s }) });
var Td = class extends import_react.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "handleMouseDown", {
      ...
      writable: true,
      value: (i) => {
        this.props.clickTolerance !== void 0 && Math.abs(this.originClickX - i.clientX) > this.props.clickTolerance && (this.cancelClick = true);
      }
      ...
      writable: true,
      value: (i) => {
        this.cancelClick || this.props.onClick(i), this.cancelClick = false, this.originClickX = null;
      }
  ...
  render() {
    const i = import_react.default.Children.only(this.props.children);
    return import_react.default.cloneElement(i, {
...
var wd = class extends import_react.Component {
  render() {
    ...
    let O = [];
    return y && (O = y(x)), (0, import_jsx_runtime.jsx)(Td, { clickTolerance: m, onClick: v, children: (0, import_jsx_runtime.jsx)("div", { onContextMenu: i, onDoubleClick: a, className: (u ? "rct-hl-even " : "rct-hl-odd ") + (O ? O.join(" ") : ""), style: f }) });
  }
};
var Sd = class extends import_react.Component {
  shouldComponentUpdate(i) {
  ...
  render() {
    ...
    for (let P = 0; P < a; P++)
      $.push((0, import_jsx_runtime.jsx)(wd, { clickTolerance: m, onContextMenu: (T) => O(T, P), onClick: (T) => f(T, P), onDoubleClick: (T) => v(T, P), isEvenRow: P % 2 === 0, group: y[P], horizontalLineClassNamesForGroup: x, style: {
        width: `${i}px`,
        height: `${u[P]}px`
      } }, `horizontal-line-${P}`));
    return (0, import_jsx_runtime.jsx)("div", { className: "rct-horizontal-lines", children: $ });
  }
};
var xd = class extends import_react.Component {
  constructor(i) {
  ...
  componentDidMount() {
    this.scrollComponentRef.current && (this.props.scrollRef(this.scrollComponentRef.current), this.scrollComponentRef.current.addEventListener("wheel", this.handleWheel, { passive: false }), this.scrollComponentRef.current.addEventListener("itemInteraction", this.handleItemInteract), this.scrollComponentRef.current.addEventListener("touchstart", this.handleTouchStart, { passive: false }), this.scrollComponentRef.current.addEventListener("touchmove", this.handleTouchMove, { passive: false }));
  }
...
var { Consumer: Cd, Provider: _d } = import_react.default.createContext(Od);
var Md = _d;
var Ed = Cd;
var Id = {
  markers: [],
...
var { Consumer: Pd, Provider: Dd } = import_react.default.createContext(Id);
var vi = 0;
var Rd = () => (vi += 1, vi + 1);
var $d = class extends import_react.default.Component {
  constructor(i) {
  ...
  render() {
    return (0, import_jsx_runtime.jsx)(Dd, { value: this.state, children: this.props.children });
  }
};
var Zt = Pd;
var Fe;
...
var Kr = (s) => function({ styles: a }) {
  return (0, import_jsx_runtime.jsx)("div", { style: a, "data-testid": s });
};
var zd = Kr("default-today-line");
...
var jd = Kr("default-customer-marker-id");
var Zi = class extends import_react.default.Component {
  render() {
...
var Ad = Kr("default-cursor-marker");
var Ji = class extends import_react.default.Component {
  constructor(i) {
...
var Qi = (s) => (0, import_jsx_runtime.jsx)(Ed, { children: ({ subscribeToMouseOver: i }) => (0, import_jsx_runtime.jsx)(Ji, { subscribeToCanvasMouseOver: i, ...s }) });
Qi.displayName = "CursorMarkerWrapper";
var Ld = () => (0, import_jsx_runtime.jsx)(qt, { children: ({ getLeftOffsetFromDate: s, getTimelineState: i }) => (0, import_jsx_runtime.jsx)(Zt, { children: ({ markers: a }) => {
  const u = i();
  return a.map((f) => {
    switch (f.type) {
      case Fe.Today:
        return (/* @__PURE__ */ new Date()).valueOf() >= u.canvasTimeStart && (/* @__PURE__ */ new Date()).valueOf() <= u.canvasTimeEnd ? (0, import_jsx_runtime.jsx)(qi, { getLeftOffsetFromDate: s, renderer: f.renderer, interval: f.interval }, f.id) : null;
      case Fe.Custom:
        return f.date >= u.canvasTimeStart && f.date <= u.canvasTimeEnd ? (0, import_jsx_runtime.jsx)(Zi, { renderer: f.renderer, date: f.date, getLeftOffsetFromDate: s }, f.id) : null;
      case Fe.Cursor:
        return (0, import_jsx_runtime.jsx)(Qi, { renderer: f.renderer, getLeftOffsetFromDate: s }, f.id);
      default:
        return null;
    }
  });
...
var Wd = class extends import_react.default.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "handleMouseMove", {
      ...
      writable: true,
      value: () => {
        this.subscription !== null && this.subscription({ leftOffset: 0, date: 0, isCursorOverCanvas: false });
      }
      ...
      configurable: true,
      writable: true,
      value: import_react.default.createRef()
  ...
  render() {
    return (0, import_jsx_runtime.jsx)(Md, { value: this.state, children: (0, import_jsx_runtime.jsxs)("div", { style: Hd, onMouseMove: this.handleMouseMove, onMouseLeave: this.handleMouseLeave, ref: this.containerEl, children: [(0, import_jsx_runtime.jsx)(Ld, {}), this.props.children] }) });
  }
};
var Fd = (s) => (0, import_jsx_runtime.jsx)(qt, { children: ({ getDateFromLeftOffsetPosition: i }) => (0, import_jsx_runtime.jsx)(Wd, { getDateFromLeftOffsetPosition: i, ...s }) });
function Ud(s) {
...
var gi = { addListener: Ud, removeListener: Nd };
var Yd = {
  groupIdKey: "id",
  groupTitleKey: "title",
...
var eo = import_react.default.createContext(Xd);
var Bd = class extends import_react.default.Component {
  render() {
    const i = {
    ...
    return (0, import_jsx_runtime.jsx)(eo.Provider, { value: i, children: this.props.children });
  }
};
var Vd = eo;
var Xr = () => (0, import_react.useContext)(Vd);
var to = { exports: {} };
(function(s) {
  (function() {
...
var Zd = "left";
var ro = "right";
var Jd = class extends import_react.PureComponent {
  constructor() {
...
var Qd = ({ getRootProps: s }) => (0, import_jsx_runtime.jsx)("div", { "data-testid": "sidebarHeader", ...s() });
var zt = (s) => {
  const { children: i, variant: a = Zd, headerData: u } = s, { leftSidebarWidth: f, rightSidebarWidth: v } = Xr();
  return (0, import_jsx_runtime.jsx)(Jd, { leftSidebarWidth: f, rightSidebarWidth: v, variant: a, headerData: u, children: i || Qd });
};
zt.secretKey = "SidebarHeader";
var ef = class extends import_react.default.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "getRootStyle", {
      ...
      configurable: true,
      writable: true,
      value: (i) => i.type === void 0 ? false : i.type.secretKey === zt.secretKey
    });
  }
  render() {
    let i, a;
    const u = [], f = Array.isArray(this.props.children) ? this.props.children.filter((v) => v) : [this.props.children];
    return import_react.default.Children.map(f, (v) => {
      var m;
      this.isSidebarHeader(v) ? ((m = v == null ? void 0 : v.props) == null ? void 0 : m.variant) === ro ? i = v : a = v : u.push(v);
    }), a || (a = (0, import_jsx_runtime.jsx)(zt, {})), !i && this.props.rightSidebarWidth && (i = (0, import_jsx_runtime.jsx)(zt, { variant: "right" })), (0, import_jsx_runtime.jsxs)("div", { "data-testid": "headerRootDiv", style: this.getRootStyle(), className: mi("rct-header-root", this.props.className), children: [a, (0, import_jsx_runtime.jsx)("div", { ref: this.props.registerScroll, style: this.getCalendarHeaderStyle(), className: mi("rct-calendar-header", this.props.calendarHeaderClassName), "data-testid": "headerContainer", children: u }), i] });
  }
};
var $r = ({ children: s, style: i, className: a, calendarHeaderStyle: u, calendarHeaderClassName: f }) => {
  const { leftSidebarWidth: v, rightSidebarWidth: m, registerScroll: y } = Xr();
  return (0, import_jsx_runtime.jsx)(ef, { leftSidebarWidth: v, rightSidebarWidth: m, registerScroll: y, style: i, className: a, calendarHeaderStyle: u, calendarHeaderClassName: f, children: s });
};
$r.secretKey = "TimelineHeaders";
var no = class extends import_react.default.Component {
  constructor(i) {
...
function tf({ children: s, unit: i, headerData: a, height: u }) {
  ...
  return (0, import_jsx_runtime.jsx)(no, { children: s, timeSteps: x, showPeriod: v, unit: i || y.timelineUnit, ...y, headerData: a, getLeftOffsetFromDate: m, height: u });
}
...
var of = class extends import_react.default.PureComponent {
  constructor() {
...
function sf({ headerContext: { intervals: s, unit: i }, getRootProps: a, getIntervalProps: u, showPeriod: f, data: { style: v, intervalRenderer: m, className: y, getLabelFormat: x, unitProp: O, headerData: $ } }) {
  return (0, import_jsx_runtime.jsx)("div", { "data-testid": "dateHeader", className: y, ...a({ style: v }), children: s.map((P) => {
    const T = x([P.startTime, P.endTime], i, P.labelWidth);
    return (0, import_jsx_runtime.jsx)(of, { unit: i, interval: P, showPeriod: f, intervalText: T, primaryHeader: O === "primaryHeader", getIntervalProps: u, intervalRenderer: m, headerData: $ }, `label-${P.startTime.valueOf()}`);
  }) });
}
var af = class extends import_react.default.Component {
  constructor() {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)(tf, { children: sf, unit: i, height: a, headerData: this.getHeaderData(this.props.intervalRenderer, this.getRootStyle(this.props.style), this.props.className, this.getLabelFormat, this.props.unit, this.props.headerData) });
  }
};
function Ti({ labelFormat: s, unit: i, style: a, className: u, intervalRenderer: f, headerData: v, height: m }) {
  return (0, import_jsx_runtime.jsx)(qt, { children: ({ getTimelineState: y }) => {
    const x = y();
    return (0, import_jsx_runtime.jsx)(af, { timelineUnit: x.timelineUnit, unit: i, labelFormat: s || lf, style: a, className: u, intervalRenderer: f, headerData: v, height: m });
  } });
}
var lf = ([s], i, a = 150, u = Kd) => {
  let f;
...
var uf = Ze(cf);
Me.extend(uf);
var oo = class extends import_react.Component {
  constructor(i) {
    super(i), Object.defineProperty(this, "getTimelineContext", {
      ...
      configurable: true,
      writable: true,
      value: (T, _, M = false, C = this.props.items, z = this.props.groups) => {
      ...
      configurable: true,
      writable: true,
      value: (T) => T.type === void 0 ? false : T.type.secretKey === $r.secretKey
      ...
      value: () => {
        if (this.props.children) {
          let T;
          if (import_react.default.Children.map(this.props.children, (_) => {
            this.isTimelineHeader(_) && (T = _);
          }), T)
            return T;
        }
        return (0, import_jsx_runtime.jsxs)($r, { children: [(0, import_jsx_runtime.jsx)(Ti, { unit: "primaryHeader" }), (0, import_jsx_runtime.jsx)(Ti, {})] });
      }
  ...
  childrenWithProps(i, a, u, f, v, m, y, x, O, $, P) {
    ...
    return import_react.default.Children.map(T, (M) => this.isTimelineHeader(M) ? null : import_react.default.cloneElement(M, _));
  }
  getSelected() {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)(dd, { visibleTimeStart: P, visibleTimeEnd: T, canvasTimeStart: _, canvasTimeEnd: M, canvasWidth: te, showPeriod: this.showPeriod, timelineUnit: re, timelineWidth: this.state.width, children: (0, import_jsx_runtime.jsx)($d, { children: (0, import_jsx_runtime.jsx)(Bd, { registerScroll: this.handleHeaderRef, timeSteps: v, leftSidebarWidth: this.props.sidebarWidth, rightSidebarWidth: this.props.rightSidebarWidth, children: (0, import_jsx_runtime.jsxs)("div", { style: this.props.style, ref: this.container, className: `react-calendar-timeline ${this.props.className}`, children: [this.renderHeaders(), (0, import_jsx_runtime.jsxs)("div", { style: S, className: "rct-outer", children: [u > 0 ? this.sidebar(z, N) : null, (0, import_jsx_runtime.jsx)(xd, { scrollRef: this.getScrollElementRef, width: $, height: z, onZoom: this.changeZoom, onWheelZoom: this.handleWheelZoom, traditionalZoom: !!m, onScroll: this.onScroll, children: (0, import_jsx_runtime.jsxs)(Fd, { children: [this.columns(_, M, te, re, v, z), this.rows(te, N, a), this.items({
      canvasTimeStart: _,
      canvasTimeEnd: M,
      canvasWidth: te,
      dimensionItems: C,
...
var Sf = (s) => s.children || null;
var so = class extends import_react.default.Component {
  constructor() {
...
var pf = (s) => (0, import_jsx_runtime.jsx)(Zt, { children: ({ subscribeMarker: i, updateMarker: a }) => (0, import_jsx_runtime.jsx)(so, { subscribeMarker: i, updateMarker: a, ...s }) });
pf.displayName = "TodayMarkerWrapper";
var hf = class extends import_react.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "unsubscribe", {
      enumerable: true,
      configurable: true,
...
var df = (s) => (0, import_jsx_runtime.jsx)(Zt, { children: ({ subscribeMarker: i, updateMarker: a }) => (0, import_jsx_runtime.jsx)(hf, { subscribeMarker: i, updateMarker: a, ...s }) });
df.displayName = "CustomMarkerWrapper";
var ff = class extends import_react.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "unsubscribe", {
      enumerable: true,
      configurable: true,
...
var vf = (s) => (0, import_jsx_runtime.jsx)(Zt, { children: ({ subscribeMarker: i }) => (0, import_jsx_runtime.jsx)(ff, { subscribeMarker: i, ...s }) });
...
react-calendar-timeline/dist/react-calendar-timeline.es.js:
  (*!
